...
- A fachada oeste da ÁREA DE SERVIÇO tem 6,14 m sem parede escura, registrados como uma janela única. Pode ser gradil, tijolo de vidro ou uma sequência de aberturas menores.
...
- O terraço aparece na cena com quatro paredes de 2,70 m. O usuário confirmou em 06/09/2026 que os três fechamentos são **gradil**, não parede, com altura por volta de 1,10 m. Corrigir exige altura por parede, que o contrato ainda não tem: hoje `wallHeight` é global. Enquanto isso, o terraço aparece fechado e mais alto do que é.
